...
export class SceneLivingLabIMTAtlantique extends Scene {
	...
	constructor() {
		super('SceneLivingLabIMTAtlantique');
	}
	...
	private initMap(): void {
		this.map = this.make.tilemap({ key: 'map_experimenthaal', tileWidth: 32, tileHeight: 32 });
